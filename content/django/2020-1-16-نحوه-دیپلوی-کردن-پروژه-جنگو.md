...
برای استفاده از Postgres  دراین قسمت ما یک دیتابیس و یک کاربر میسازیم که بتونیم پروژه جنگو رو به Postgres متصل کنیم . 
...
حالا ما یه دیتابیس ساختیم و یه کاربر ٬ الان باید این کاربر رو به دیتابیس که در مرحله اول ساختیم وصل کنیم . برای این کار :
