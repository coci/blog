...
ببنید گفتیم ما برای ساخت بلاک جدید میایم بلاک قبلی رو hash میکنیم و به بلاک جدید اضافه میکنیم ، حالا ما میایم سطح امنیتی بلاک رو بیشتر میکنیم و میگیم مثلا یه عددی به علاوه hash بلاک مثلا حاصلی کمتر از ۱۰۰ داشته باشه یا ۴ رقم اخر صفر بشه(مسئله) ، که این مسئله رو خود صاحب بلاک طرح میکنه ، اینطوری ما بلاک مهر و موم (sign) میکنیم و هیچکس نمیتونه توش دستکاری بکنه . اگه متوجه نشدین به مثال توجه کنین :
...
x + y = 1253e9373e...5e3600155e860	# we dont have "y"
